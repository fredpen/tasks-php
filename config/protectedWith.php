...
return [
    ...
    'project' => ['task:name,id', 'subtask:name,id', 'owner:name,id,orders_out,orders_in,ratings,ratings_count', 'country:name,id', 'region:name,id', 'city:name,id', 'photos:url,project_id'],
     ...
     'projectAndApplication' => ['task:name,id', 'subtask:name,id', 'owner:name,id,orders_out,orders_in,ratings,ratings_count', 'country:name,id', 'region:name,id', 'city:name,id', 'photos:url,project_id'],
